...
ARG VITE_WHAPI_API_URL
ARG VITE_WHAPI_TOKEN
ARG VITE_WHAPI_WEBHOOK_URL
ARG VITE_CONFIG_WEBHOOK_URL
...
ENV VITE_USE_BASE_PATH=$VITE_USE_BASE_PATH
ENV VITE_WHAPI_API_URL=$VITE_WHAPI_API_URL
ENV VITE_WHAPI_TOKEN=$VITE_WHAPI_TOKEN
ENV VITE_WHAPI_WEBHOOK_URL=$VITE_WHAPI_WEBHOOK_URL
ENV VITE_CONFIG_WEBHOOK_URL=$VITE_CONFIG_WEBHOOK_URL
